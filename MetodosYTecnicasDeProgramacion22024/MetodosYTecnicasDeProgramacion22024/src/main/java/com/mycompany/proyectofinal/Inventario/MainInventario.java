...
public class MainInventario {
    ...
    private final String FILE_NAME = "C:\\Proyectos\\MetodosYTecnicasDeProgramacion22024\\ProyectoFinal\\src\\main\\java\\productos.txt";  // Nombre del archivo donde guardaremos los productos
    ...
    public void agregarProducto() {
        ...
        Producto nuevoProducto = new Producto(nombre, unidad, cantidad, proveedor, telefono);
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(FILE_NAME))) {
            ...
            while ((linea = reader.readLine()) != null) {
                ...
                if (datos.length == 5) {
                    ...
                    Producto producto = new Producto(nombre, unidad, cantidad, proveedor, telefono);
