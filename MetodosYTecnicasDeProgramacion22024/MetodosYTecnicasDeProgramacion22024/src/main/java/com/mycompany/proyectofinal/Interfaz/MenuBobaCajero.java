 ...
 * @author Usuario
 */
public class MenuBobaCajero extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public MenuBobaCajero() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuBobaCajero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuBobaCajero().setVisible(true);
            }
        });
    }
