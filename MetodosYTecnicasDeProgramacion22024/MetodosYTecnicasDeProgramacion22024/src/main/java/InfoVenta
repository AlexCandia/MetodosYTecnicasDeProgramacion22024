...
public class InfoVenta {
    ...
    // Atributos
    private int numVaso; // Número de vaso en la venta
    ...
    // Constructor
    public InfoVenta(int numVaso, Date fecha, String tamVaso, String base, String tipoBoba, String sabor1, String sabor2) {
    ...
    public int getNumVaso() {
        return numVaso;
    }

    public void setNumVaso(int numVaso) {
        this.numVaso = numVaso;
    }
