...
import Inventario.Notificacion;
...
// Atributos de la clase GestorDeVentas
    ...
    private Queue<Vaso> colaDeVasos;
    ...
    public GestorDeVentas(GestorDeInventario inventario) {
        ...
        this.colaDeVasos = new LinkedList<>();
    ...
    //Es la forma de iniciar un nuevo pedido
    ...
    public void marcarPedidoCompletado() {
        if(!colaDeVasos.isEmpty()){
            Vaso vasoCompletado = colaDeVasos.poll();
            actualizarinfo(vasoCompletado);
            System.out.print("El vaso Nro: " + vasoCompletado.getNumVaso());
            System.out.print("Del Pedido: " + vasoCompletado.getCodPedido());
    ...
    private void actualizarinfo(Vaso vasoCompletado) {
        String sabor1 =vasoCompletado.getSabor1();
        String sabor2 =vasoCompletado.getSabor2();
        String tamaño =vasoCompletado.getTamVaso();
        String perlas =vasoCompletado.getTipoBoba();
        String base =vasoCompletado.getBase();
